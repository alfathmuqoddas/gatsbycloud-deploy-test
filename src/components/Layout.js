  ...
  return (
    <div className="layout font-inter">
      ...
      <footer className="bg-gray-900 py-16 text-center">
        <p className="text-white">©2021 Alfath Muqoddas</p>
        ...
        <div className="text-3xl pt-2 text-white">
          ...
          <a href="https://codepen.io/alfathmuqoddas" target="_blank" rel="noreferrer" className="inline-block mr-4"><i className="fab fa-codepen hover:text-blue-400" aria-label="codepen"></i></a>
