...
const projects = [
  {
	  ...
	  desription:"Minimalist and elegant weather forecast app, built with vanilla JavaScript",
  ...
  },
  {
	  ...
	  title:"GreenCloud",
	  desription:"Landing page based on DigitalOcean website",
  ...
  },
  {
	  ...
	  title:"BBC Clone",
	  desription:"Replicating the BBC News Website built with TailwindCSS",
  ...
  },
  {
	  ...
	  title:"TravelMate",
	  desription:"Simple travel landing page built with BootstrapCSS",
...
const reactProjects =[
  {
	  ...
	  title:"Tour.Ink",
	  desription:"Travel landing page built with React + GatsbyJS +GraphQL",
	  liveLink:"/tour-ink",
  ...
  },
  {
	  ...
	  title:"SpaceX App",
	  desription:"Apps built with Gatsby JS and GRaphQL data fethcing from SpaceX api",
	  liveLink:"/spacex-app",
